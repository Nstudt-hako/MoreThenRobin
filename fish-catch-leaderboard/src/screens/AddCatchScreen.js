  ...
  if (!user) {
    return (
      <div style={{ padding: "2rem", textAlign: "center" }}>
        <h1 style={{ color: "var(--color-primary)" }}>Add Catch</h1>
  ...
  return (
    <div className="form-container">
      ...
      <form onSubmit={onSubmit} noValidate>
        ...
        {error && (
          <p style={{ color: "var(--color-error)", marginBottom: "0.5rem" }}>
            {error}
          </p>
        )}
        {success && (
          <p style={{ color: "green", marginBottom: "0.5rem" }}>Catch added!</p>
        )}
